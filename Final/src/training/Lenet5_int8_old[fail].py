...
train_images_subset = train_images[0:50000] # out of 60000
train_labels_subset = train_labels[0:50000]

q_aware_model.fit(train_images_subset, train_labels_subset,
                  batch_size=2000, epochs=5, validation_split=0.1)
...
tflite_interpreter = tf.lite.Interpreter(model_content=quantized_tflite_model)
tflite_interpreter.allocate_tensors()
tensor_details = tflite_interpreter.get_tensor_details()
for dic in tensor_details:
    i = dic['index']
    tensor_name = dic['name']
    scales = dic['quantization_parameters']['scales']
    zero_points = dic['quantization_parameters']['zero_points']
